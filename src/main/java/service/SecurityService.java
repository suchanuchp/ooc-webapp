...
public class SecurityService {
    ...
    public static final String MYSQL_URL = String.format("jdbc:mysql://%s:%s/a4?useSSL=false&allowPublicKeyRetrieval=true&characterEncoding=UTF-8&user=root&password=12345", DATABASE_HOSTNAME, DATABASE_PORT);
